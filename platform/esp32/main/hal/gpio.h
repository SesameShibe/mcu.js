...
static void halGpioConfig(u32 pin, u32 mode, u32 pupd) {
	gpio_config_t io_conf = { .pin_bit_mask = ((uint64_t)1 << pin),
		                      ...
		                      .pull_up_en = (pupd == HAL_GPIO_PUPD_PULLUP) ? GPIO_PULLUP_ENABLE :GPIO_PULLUP_DISABLE,
		                      .pull_down_en = (pupd == HAL_GPIO_PUPD_PULLDOWN) ? GPIO_PULLDOWN_ENABLE : GPIO_PULLDOWN_DISABLE,
